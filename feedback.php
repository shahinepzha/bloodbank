...
<div id="back" align="right">
    <a href="customerhome.html"><H3><font color="black">Back</font></H3></a>
</div>
<form action="feedback.php" method="POST">
    <h2><center>Add Feedback</center></h2><br>
    <table align="center" style="width:50%">
        <tr>
            <td>Give Feedback:</td>
            <td><input type="text" name="fb" id="name"></td>
        </tr>
        <tr>
            <td>Date:</td>
            <td><input type="text" name="da" id="name"></td>
        </tr>
        
            <td> </td>
            <td></br><input type="submit" name="register" id="register" value="SUBMIT" onclick="return valid();"></td></br>
...
if($_POST)
{
    ...
    $bg=$_POST['fb'];
    $bg1=$_POST['da'];
    $sql="insert into feedback(feedback,date)values('$bg','$bg1')";
