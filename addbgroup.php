...
<form action="addbgroup.php" method="POST">
    <h2><center>Add BloodGroup</center></h2><br>
    <table align="center" style="width:50%">
        <tr>
            <td>Blood Group:</td>
            <td><input type="text" name="bgroup" id="name"></td>
        </tr>
        <tr>
            <td> </td>
...
if($_POST)
{
    ...
    $bg=$_POST['bgroup'];
    $sql="insert into bgroup(bgroup)values('$bg')";
