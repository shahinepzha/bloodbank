...
<h1><marquee direction="left">View Blood Requests</marquee></h1><br>
<form method="post" id="view" >
    <table  border="2" align="center">
        ...
        <?php
        require("connect.php");
        $result=mysqli_query($con,"select * from request where bgroup='$group1' and request='pending'");
        ...
        if(mysqli_num_rows($result) >0)
        {
            ...
            while($row1=mysqli_fetch_array($result)){
                ...
                <tr>
                   ...
                   <td><a href="donoracceptrequest.php?id= <?php echo $row1[0];?>"  ><font color="red"><?php echo $row1[7];?></font></a></td>
